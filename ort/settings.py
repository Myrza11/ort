...
SECRET_KEY = 'django-insecure-+7ge)d!6o%apl3=$udy5)e!*f1sid6lt9%^wf64x1j7ej%ryfl'
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(days=7),  # устанавливаем время жизни токена на 7 дней
}
